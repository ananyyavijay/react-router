      ...
      <div className="container m-auto px-6 text-gray-600 md:px-12 xl:px-6">
        <div className="space-y-6 md:space-y-0 md:flex md:gap-6 lg:items-center lg:gap-12">
          ...
          <div className="md:7/12 lg:w-6/12">
            ...
            <br />
            <p className="mt-7 text-gray-600 text-xl">
              ...
              strawberry lovers everywhere. Whether you're looking to eat
              healthier, find natural beauty remedies, or simply learn more
              about your favorite fruit, we’ve got you covered. From
              science-backed articles and recipes to growing tips and wellness
              guides, everything we share is rooted in our love for this
              incredible superfruit. 
            </p>
            <p className="mt-9 text-gray-600 text-2xl font-medium">
             Let’s grow strong, stay sweet, and live
              vibrant—one strawberry at a time.
            </p>
          </div>
        </div>
      </div>
